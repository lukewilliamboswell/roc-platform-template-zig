...
extern fn roc__str_new(effects: *const PlatformEffects, out: *RocStr, data: [*]const u8, len: *const u64) void;
extern fn roc__str_incref(str: *RocStr) void;
extern fn roc__str_decref(effects: *const PlatformEffects, str: *RocStr) void;
